...
#### Mapas conceptuales.
Es una técnica usada para la representación grafica del conocimiento, es decir, es una red de conceptos. En la red los nodos representan los conceptos y los enlaces representan las relaciones entre conceptos.
###### Elementos.
...
### Mapas de ideas  
Es un diagrama que por medio de colores, lǵoca y ritmo visual, números imágenes y palabras clave, reúne los puntos importantes de un tema, e implica de forma explicita la forma en que estos se relacionan entre si.
###### Origen del mapa mental
Fue desarrollado por el Tony Busant en 1969.

##### Beneficios del mapa mental
- Desarrolla la memoria y el pensamiento rápido y creativo.
- Ahorra tiempo
- Aumenta la productividad y la rentabilidad
- Involucran todo el cerebro y facilita el recuerdo y la comprensión.
- Estimulan la lectura, el estudio y la investigación.

##### Características de los mapas de ideas
- La idea principal se simboliza en una imagen central.
- Los temas principales irradian del tema central como bifurcaciones.
- Las bifurcaciones incluyen una imagen o palabra clave dibujada o impresa en su linea asociada.
- Los temas de menor importancia se representan como ramas de la bifurcación oportuna.
- Las bifurcaciones forma una estructura en nodos conectados

##### Elementos de los mapas mentales
- Conceptos. Se refieren a hechos, objetos, cualidades, se identifican como nombres, adjetivos y pronombres.
- Palabras enlace. Conjunciones,adverbios en general todas las palabras que no sean concepto.
- Proposición. Es la frase con un significado determinado que se forma con 3 o mas conceptos unidos por palabras enlace.
- Elipses (óvalos).
- Lineas.

##### ¿Como crear un mapa mental?
1. Definir el concepto central y colocarlo en el centro.
2. Ubicar ideas alrededor del concepto central con etiquetas con o sin recuadros y con lineas que se desprendan del concepto central.
3. Usar imágenes si es que se adaptan al tiempo y propósito del tema.
4. Usar colores diferentes para cada nivel de idea creando así una organización visual.
5. Dibujar lineas rectas o curvas.
6. Desarrollar el mapa conforme al estilo personal

##### Diferencias entre mapas mentales y mapas conceptuales
Un mapa conceptual pose una estructura sobria y no es común el uso de imágenes, resultado que los mapas mentales llaman mas la atención.
- El tipo de texto usado en los mapas conceptuales se pueden expresar diferentes ideas, en los mapas mentales el uso de oraciones queda reducido (solo palabras clave) con el objetivo que la información llegue mas prontamente al cerebro.
- Jerarquía. en los mapas conceptuales la idea se coloca en la parte superior del mapa, mientras que en los mentales se coloca en el centro.
- Contenido. Los conceptuales tiene su contenido orientado mediante una pregunta de enfoque. Mientras que los mentales tienen su desarrollo entorno a una idea central, solo se habla de una idea.
- El mapa mental no se permite el enlazamiento cruzado, pero en el conceptual si.
